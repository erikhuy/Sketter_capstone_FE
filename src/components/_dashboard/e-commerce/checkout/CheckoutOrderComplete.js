...
import {Box, Button, Divider, Link, Stack, Typography} from '@material-ui/core';
// material
import {styled} from '@material-ui/core/styles';
import {useNavigate} from 'react-router-dom';
import {resetCart} from 'shared/redux/slices/product';
// redux
			...
			<Box sx={{p: 4, maxWidth: 480, margin: 'auto'}}>
				<Box sx={{textAlign: 'center'}}>
					...
					<Typography align="left">
						...
						<br /> <br /> If you have any question or queries then fell to get in contact us. <br /> <br />{' '}
						All the best,
					</Typography>
				</Box>
